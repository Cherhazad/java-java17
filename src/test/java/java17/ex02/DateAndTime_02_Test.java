...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format_with_hour() {
		...
		System.out.println("cela ne s'affiche pas");
		System.out.println("cela ne s'affiche pas non plus" + result);
	...
	public void test_with() {
		...
		LocalDate result = localDate.withYear(2015).withDayOfMonth(05).withMonth(02);
